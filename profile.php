...
<!--                                Inlucding dashboard menu-->
    ...
    ?>
                                        ...
                                        <form action="src/profiles/profile_update.php" method="POST" class="form-horizontal row-fluid">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="first_name">First Name: <?php
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="last_name">Last Name:  <?php
                                   ...
                                   echo $my_profile['last_name'];
                                        ...
                                        ?></label>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="password">Password : <?php
    ...
    ?></label>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="mobile_number">Mobile Number: <?php
                                    ...
                                    if (isset($my_profile['address'])) {
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="zip_code">Zip Code : <?php
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="city">City : <?php
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="district">District : <?php
...
<!--                                            </div>-->
            ...
            <div class="footer">
                <div class="container">
                    <b class="copyright">&copy; 2015 Mizanur Rahman Riyadh </b>All rights reserved.
                </div>
            </div>
